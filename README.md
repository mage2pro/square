The extension integrates your Magento 2 store with the **[Square](https://squareup.com/developers)** payment service.
...
rm -rf pub/static/* && bin/magento setup:static-content:deploy <locale, e.g.: en_CA>
...
- [Subscribe](https://mage2.pro/t/2540) to the extension's [forum branch](https://mage2.pro/c/extensions/square).
